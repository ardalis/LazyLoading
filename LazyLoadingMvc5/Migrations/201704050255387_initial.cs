namespace LazyLoadingMvc5.Migrations
{
    ...
    public partial class initial : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.SpeakerSessions", "SpeakerId", "dbo.Speakers");
            DropForeignKey("dbo.SpeakerSessions", "SessionId", "dbo.Sessions");
            ...
            DropIndex("dbo.SpeakerSessions", new[] { "SessionId" });
            DropIndex("dbo.SpeakerSessions", new[] { "SpeakerId" });
